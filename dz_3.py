...
class Classmate(Person):
    ...
    def introduce(self):
        education = "есть высшее образование" if self.has_higher_education() else "нет высшего образования"
        print(f"Привет, меня зовут {self.name}, учились вместе в {self.classroom}, "
              f"работаю {self.get_occupation().lower()}ом, у меня {education}.")


people = [
    Friend(name="Алмаз", birth_date="05.12.2005", occupation="Программист", higher_education=True,
           hobby="играть в шахматы"),
    Friend(name="Алия", birth_date="22.07.2001", occupation="Дизайнер", higher_education=True, hobby="рисование"),
    Classmate(name="Бектур", birth_date="11.09.1999", occupation="Инженер", higher_education=True, classroom="11 Д"),
    Classmate(name="Эльдар", birth_date="01.03.2004", occupation="Маркетолог", higher_education=False,
              classroom="10 Б")
]

for person in people:
    person.introduce()
    print(f'Мне {person.age} лет')